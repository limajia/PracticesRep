...
public class ViewMainFunsView22 extends View {

    private static final String TAG = "ViewMainFunsView22";

    public ViewMainFunsView22(Context context) {
        super(context);
        Log.d(TAG, "ViewMainFunsView() called with: context = [" + context + "]");
    }

    public ViewMainFunsView22(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG, "ViewMainFunsView() called with: context = [" + context + "], attrs = [" + attrs + "]");
    }

    public ViewMainFunsView22(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
