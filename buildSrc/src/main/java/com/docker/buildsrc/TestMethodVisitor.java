...
public class TestMethodVisitor extends AdviceAdapter {
     ...
     * <p>
     * api           the ASM API version implemented by this visitor. Must be one of {@link
...
//        addLogThis();
//        addTimeDifference();
        if (annotationDes.equals("Lcom/docker/gradletoasmstakedemo/TestAnnotation;")) {
            addLog();   //直接把原来的return值 给替换了
        }
    ...
    public AnnotationVisitor visitAnnotation(String descriptor, boolean visible) {
        ...
        if (descriptor.equals("Lcom/docker/gradletoasmstakedemo/TestAnnotation;")) {
    ...
    private void addLog() {
        ...
        mv.visitLdcInsn("HelloWorld sayHello docker");
