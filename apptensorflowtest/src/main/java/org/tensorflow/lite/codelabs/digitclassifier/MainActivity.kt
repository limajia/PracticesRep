...
//codelab link: https://developer.android.com/codelabs/digit-classifier-tflite#0
class MainActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    findViewById<View>(R.id.goto_canvas_button).setOnClickListener {
      startActivity(Intent(this, com.divyanshu.draw.activity.DrawingActivity::class.java))
    }
