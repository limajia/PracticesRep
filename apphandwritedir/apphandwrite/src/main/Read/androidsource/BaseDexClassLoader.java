...
public class BaseDexClassLoader extends java.lang.ClassLoader {
     ...
     */
    public BaseDexClassLoader(String dexPath, File optimizedDirectory,
                              String librarySearchPath, java.lang.ClassLoader parent, boolean isTrusted) {
        super(parent);
    ...
    private void reportClassLoaderChain() {
        ...
        java.lang.ClassLoader bootClassLoader = java.lang.ClassLoader.getSystemClassLoader().getParent();
        java.lang.ClassLoader current = getParent();
