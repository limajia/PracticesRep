...
/**
 * 选择，插入，归并， 升级版的快速排序/双轴快速排序
 */
public class Select2Insert2merge2Sorts {

    /**
     * 插入排序  先选中一个边数据，从第二个开始。
     * 这样就有一个空位置了。且可以将第二个插入到第一个的左边或者右边
     *
     * 对比 选择排序 就是选定一个方向，选中一个边值，其他进行和边值选择对比，找到最值，交换即可。
     *
     */
    ...
    public static void mergeSort(int[] arr, int left, int right) {
        ...
        mergeSort(arr, q + 1, right); //不断地进入拆分环节
        merge2(arr, left, q, right);// 这是拆分完后 无法再次查分后的合并 可以使用各种婆娘个排序方法
    }
