...
public class BubbleRelativeLayout extends RelativeLayout {
    ...
    public static int SHADOW_COLOR = Color.argb(255, 255, 0, 0);
    public static int LEG_HALF_BASE = 30;//尖角的一半距离
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                CORNER_RADIUS = a.getFloat(R.styleable.bubble_cornerRadius1, CORNER_RADIUS);
            } finally {
                if (a != null) {
                    a.recycle();
                }
        ...
        mPaint.setShadowLayer(2f, 2F, 2F, SHADOW_COLOR);
